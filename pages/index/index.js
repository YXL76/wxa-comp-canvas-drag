...
Page({
  ...
  onImport () {
    ...
    // 无背景
    const tempTheme = [{
      type: 'image', url: '../../assets/images/test.jpg', y: 103, x: 91, w: 120, h: 120, rotate: 0, sourceId: null
    }, {
      type: 'text', text: 'helloworld', color: 'blue', fontSize: 20, y: 243, x: 97, rotate: 0
    }]
